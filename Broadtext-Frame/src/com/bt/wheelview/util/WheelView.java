...
public class WheelView extends View
{
    ...
    /** Additional items height (is added to standard text item height) 480*800*/
    private   int ADDITIONAL_ITEM_HEIGHT = 25;
    ...
    private void initData(Context context)
    {
    	...
    	if (w >= 1080) {
			ADDITIONAL_ITEM_HEIGHT = ADDITIONAL_ITEM_HEIGHT*2;
			TEXT_SIZE =  TEXT_SIZE*2;
		}else if (w >= 720) {
			ADDITIONAL_ITEM_HEIGHT = (int)(ADDITIONAL_ITEM_HEIGHT*1.5);
			TEXT_SIZE = (int)(1.5*TEXT_SIZE);
		}
//    	ADDITIONAL_ITEM_HEIGHT = densityUtil.dip2px(25);
