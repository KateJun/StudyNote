...
public class MultiRadioGroup extends LinearLayout {
    ...
    /** 给RadioButton添加监听     */
	public void addChildListener(ViewGroup group) {
		int len = group.getChildCount();
		for (int i = 0; i < len; i++) {
			if (group.getChildAt(i) instanceof RadioButton) {
				RadioButton resBtn = (RadioButton) group.getChildAt(i);
    ...
    /** 给RadioButton解除监听     */
	public void removeChildListener(ViewGroup group) {
		int len = group.getChildCount();
		for (int i = 0; i < len; i++) {
			if (group.getChildAt(i) instanceof RadioButton) {
				RadioButton resBtn = (RadioButton) group.getChildAt(i);
				resBtn.setOnCheckedChangeListener(null);
			} else if (group.getChildAt(i) instanceof ViewGroup) {
				findRadioButton((ViewGroup) group.getChildAt(i));
			}
		}
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            ...
            } else if (parent == MultiRadioGroup.this
                    && child instanceof ViewGroup) {
            	  
            	addChildListener((ViewGroup) child);
            }
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == MultiRadioGroup.this && child instanceof RadioButton) {
                ((RadioButton) child).setOnCheckedChangeListener(null);
                    ...
                    && child instanceof ViewGroup) {
                removeChildListener((ViewGroup) child);
            }
            if (mOnHierarchyChangeListener != null) {
