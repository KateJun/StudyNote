...
import com.bt.album.util.BitmapCache;
import com.bt.album.util.ImageBucket;
import com.bt.album.util.BitmapCache.ImageCallback;
import com.bt.R;

public class ImageAlbumBuketAdapter extends BaseAdapter {
	...
	public ImageAlbumBuketAdapter(Activity act, List<ImageBucket> list) {
		this.act = act;
		dataList = list;
